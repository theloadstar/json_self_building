...
static void test_parse_miss_comma_or_curly_bracket() {
    ...
    TEST_PARSE_ERROR(LEPT_PARSE_MISS_COMMA_OR_CURLY_BRACKET, "{\"a\":{},\"v\": {}");
}
...
static void test_parse_invalid_value(){
    ...
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_VALUE,"invalid");
#if 1
    /*test invalid number*/
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_VALUE,"+0");
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_VALUE, "+1");
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_VALUE, "0.x");
